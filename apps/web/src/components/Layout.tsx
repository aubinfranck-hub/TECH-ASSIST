...
function Brand() {
  return (
    <span className="flex items-center gap-2.5">
      <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-600 text-sm font-black tracking-tight text-white shadow-sm">
        TA
      </span>
      <span className="leading-none">
        <span className="block text-base font-extrabold tracking-tight text-slate-950">Tech Assist</span>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div className="ta-container flex h-[72px] items-center justify-between gap-4">
          <Link to="/" aria-label="Tech Assist - Accueil">
            <Brand />
          </Link>

          <nav className="hidden items-center gap-1 md:flex" aria-label="Navigation principale">
            <Link to="/diagnostic" className="rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-brand-50 hover:text-brand-700">
              Diagnostic
            </Link>
            <Link to="/session" className="rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-brand-50 hover:text-brand-700">
              Ma session
            </Link>
            <Link to="/entreprise" className="rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-brand-50 hover:text-brand-700">
              Entreprises
            </Link>
            <Link to="/technicien" className="ml-2 rounded-xl bg-slate-950 px-4 py-2.5 text-sm font-semibold text-white hover:bg-slate-800">
              Espace technicien
            </Link>
          </nav>

          <Link to="/diagnostic" className="ta-button-primary py-2.5 md:hidden">
            Assistance
          </Link>
        </div>
        ...
        <div className="border-t border-slate-100 md:hidden">
          <nav className="ta-container flex gap-1 overflow-x-auto py-2" aria-label="Navigation mobile">
            <Link to="/diagnostic" className="whitespace-nowrap rounded-lg bg-brand-50 px-3 py-2 text-xs font-semibold text-brand-700">
              Diagnostic
            </Link>
            <Link to="/session" className="whitespace-nowrap rounded-lg px-3 py-2 text-xs font-medium text-slate-600">
              Ma session
            </Link>
            <Link to="/entreprise" className="whitespace-nowrap rounded-lg px-3 py-2 text-xs font-medium text-slate-600">
              Entreprises
            </Link>
            <Link to="/technicien" className="whitespace-nowrap rounded-lg px-3 py-2 text-xs font-medium text-slate-600">
              Technicien
            </Link>
          </nav>
        </div>
